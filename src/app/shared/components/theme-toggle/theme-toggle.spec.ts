...
function createComponent(resolved: 'light' | 'dark', toggle = vi.fn()) {
  TestBed.configureTestingModule({
    providers: [{ provide: ThemeService, useValue: { resolved: signal(resolved), toggle } }],
  });
...
describe('ThemeToggle', () => {
  ...
  it('calls ThemeService.toggle() on click', () => {
    const { fixture, toggle } = createComponent('light');
    const button: HTMLButtonElement = fixture.nativeElement.querySelector('button');
